...
import 'package:ridexpressdriver/app/modules/profile/views/upload_document_screen.dart';
...
class AppPages {
  static final List<GetPage> pages = [
    ...
    GetPage(
      name: AppRoutes.uploadDocScreen,
      page: () {
        ...
        return UploadDocumentScreen(title: title);
      },
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        return RateDriverScreen(rideModel: rideModel);
      },
    ),
    GetPage(
    ...
    GetPage(name: AppRoutes.ratingStatScreen, page: () => RatingStatScreen()),
